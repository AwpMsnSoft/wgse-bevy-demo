...
lazy_static! {
    pub static ref MAIN_TITLE_LAYOUT: Vec<Descriptor> = vec![descriptor!(
        ...
        WidgetDescriptor::image(image!((WINDOW_WIDTH, WINDOW_HEIGHT), (0.0, 0.0))),
        Some(GroupDescriptor(vec![
            descriptor!(
                MAIN_TITLE_START_BUTTON_GUID.0,
                WidgetDescriptor::button(button!((100.0, 40.0), (200.0, 480.0))),
                None
            ),
            descriptor!(
                MAIN_TITLE_CONFIG_BUTTON_GUID.0,
                WidgetDescriptor::button(button!((100.0, 40.0), (300.0, 480.0))),
                None
            ),
            descriptor!(
                MAIN_TITLE_EXTRA_BUTTON_GUID.0,
                WidgetDescriptor::button(button!((100.0, 40.0), (400.0, 480.0))),
                None
            ),
            descriptor!(
                MAIN_TITLE_EXIT_BUTTON_GUID.0,
                WidgetDescriptor::button(button!((100.0, 40.0), (500.0, 480.0))),
                None
            )
        ]))
    ),];
    ...
    pub static ref START_TITLE_LAYOUT: Vec<Descriptor> = vec![descriptor!(
        ...
        Some(GroupDescriptor(vec![
            descriptor!(
                ...
                WidgetDescriptor::button(button!((787.0, 142.0), (13.0, 450.0))),
                None
            ),
            descriptor!(
    ...
    pub static ref CONFIG_SPEED_TITLE_LAYOUT: Vec<Descriptor> = vec![descriptor!(
        ...
        Some(GroupDescriptor(vec![
            descriptor!(
                ...
                WidgetDescriptor::button(button!((130.0, 39.0), (62.0, 514.0))),
                None
            ),
            descriptor!(
                CONFIG_SPEED_TITLE_SOUND_BUTTON_GUID.0,
                WidgetDescriptor::button(button!((130.0, 39.0), (212.0, 514.0))),
                None
            ),
            descriptor!(
                CONFIG_SPEED_TITLE_EXTRA_BUTTON_GUID.0,
                WidgetDescriptor::button(button!((130.0, 39.0), (362.0, 514.0))),
                None
            ),
            descriptor!(
                CONFIG_SPEED_TITLE_BACK_BUTTON_GUID.0,
                WidgetDescriptor::button(button!((115.0, 48.0), (665.0, 528.0))),
                None
            ),
            descriptor!(
                CONFIG_SPEED_TITLE_SKIP_READED_ON_BUTTON_GUID.0,
                WidgetDescriptor::button(button!((36.0, 19.0), (372.0, 344.0))),
                None
            ),
            descriptor!(
                CONFIG_SPEED_TITLE_SKIP_READED_OFF_BUTTON_GUID.0,
                WidgetDescriptor::button(button!((36.0, 24.0), (437.0, 339.0))),
                None
            )
        ]))
    )];
